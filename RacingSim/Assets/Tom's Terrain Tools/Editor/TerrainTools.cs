...
namespace TTT
{
    public class TerrainTools : EditorWindow
    {
        ...
        private Object splatMapAutoMagic;
        ...
        void DrawAutoMagicGUI()
        {
            ...
            if (toggleAutoMagic)
            {
                ...
                GUILayout.BeginHorizontal();
                splatMapAutoMagic = EditorGUILayout.ObjectField(new GUIContent("Splatmap Object", "Heightmap, Splatmap, Treemap, Grassmap"), splatMapAutoMagic, typeof(Object), false);
                GUILayout.EndHorizontal();
                GUILayout.BeginHorizontal();
        ...
        void AutoMagic()
        {
            if (splatMapAutoMagic == null) { Debug.LogError("No splatmap assigned in automagic splat slot"); return; }
            ...
            string origPath = AssetDatabase.GetAssetPath(splatMapAutoMagic);
